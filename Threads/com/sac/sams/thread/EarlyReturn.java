...
public class EarlyReturn extends Object {
	...
	public synchronized boolean waitUntilAtLeast(int minValue, long msTimeout)
		...
		System.out.println("entering waitUntilAtLeast() - " + "value=" + value
				+ ",minValue=" + minValue);
		long endTime = System.currentTimeMillis() + msTimeout;
		long msRemaining = msTimeout;
		if (value < minValue && (msRemaining > 0L)) {
			wait(msRemaining);
	...
	public static void main(String[] args) {
		try {
			...
			boolean retVal = er.waitUntilAtLeast(5, 300000000);
			long elapsedTime = System.currentTimeMillis() - startTime;

			System.out
					.println("after " + elapsedTime + " ms, retVal=" + retVal);
